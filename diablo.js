...
global.ownerName = 'Vanzreal'
global.ownerNumber = ["6283178314449@s.whatsapp.net"]
global.prefa = ['','.']
global.mess = {
...
▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
                    𝗠𝗘𝗡𝗨
▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
BOT NAME : Vanz _ Botz
RUNING ON : PANEL
OWNER : wa.me/6283178314449
...
break
case 'akses':
diablobotwhatsapp.reply(`SEWA BOT?15K AJA 1 BULAN SUNG WA : wa.me/6289514620695`)
break
case 'sewa':
diablobotwhatsapp.reply(`SEWA BOT?15K AJA 1 BULAN SUNG WA : wa.me/6289514620695`)
break
...
case 'addakses':
 if (!isGroup) return diablobotwhatsapp.reply(`wajib dalam grup`)
if (!isGroupAdmins) return diablobotwhatsapp.reply(`siapa lu?? so asik kntl`)
